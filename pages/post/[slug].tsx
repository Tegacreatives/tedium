          ...
          {submitted ? (
            ...
            <form
                ...
                <label className="block mb-5">
                    ...
                    w-full ring-yellow-500" type="text" placeholder="Name" />
                </label>
                <label className="block mb-5">
